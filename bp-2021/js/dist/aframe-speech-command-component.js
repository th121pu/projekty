    ...
    /***/ function (module, exports) {
        ...
        AFRAME.registerComponent('speech-command', {
            ...
            executeCommand: function () {
                ...
                if (this.data.type == 'attribute') {
                    ...
                    //TODO
                    if (this.data.function.includes('+')) {
                        window[this.data.function.split("+")[0]](this.data.function.split("+")[1]);
                    } else window[this.data.function]();
        ...
        AFRAME.registerComponent('annyang-speech-recognition', {
            init: function () {
                ...
                let el = this.el;
                el.addEventListener('startspeech', function (evt) {
                        if (annyang) {
