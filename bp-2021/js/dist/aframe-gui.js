...
//icon font variables
        ...
        window.drawText = function (ctx, canvas, text, fontSize, fontFamily, color) {
            ...
            var fontWeight = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : '540';

            ctx.font = fontWeight + ' ' + fontSize + ' ' + 'Helvetica';
            ctx.fillStyle = color;
            ctx.textAlign = align;
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        AFRAME.registerComponent('gui-button', {
            schema: {
                ...
                fontSize: {type: 'string', default: '120px'},
                fontFamily: {type: 'string', default: 'Arial'},
                fontWeight: {type: 'string', default: 'normal'},
                fontColor: {type: 'string', default: key_offwhite},
                borderColor: {type: 'string', default: key_offwhite},
                backgroundColor: {type: 'string', default: key_grey},
                hoverColor: {type: 'string', default: "#95c1e8"},
                activeColor: {type: 'string', default: "#95c1e8"},
                adjust: {type: 'boolean', default: false},
                simadjust: {type: 'boolean', default: false},
            },
            init: function init() {
                ...
                el.addEventListener('animation', function (event) {
                    buttonEntity.setAttribute('animation__leave', 'property: material.color; from: ' + data.hoverColor + '; to:' + data.backgroundColor + '; dur:200; easing: easeOutQuad;');
                    setTimeout(function () {
                        buttonEntity.removeAttribute('animation__leave');
                    }, 300);
                ...
                el.addEventListener(data.on, function (event) {
                    ...
                    if (data.simadjust) {
                        ...
                        let intr = setInterval(function () {
                            if (doListen === true) {
                                run(clickActionFunctionName, el.id);
                            }
                        ...
                        let interval = setInterval(function () {
                            if (doListen === true) {
                                postElementPress(el.id)
                                let event = new CustomEvent('animation');
                                el.dispatchEvent(event);
                            }

                            if (++i === 1000 || doListen === false) clearInterval(interval);
                        }, 1750)
                        //TODO
                    } else {
                        clickActionFunction = window[clickActionFunctionName];
                    }

                    if (typeof clickActionFunction === "function") {
                        clickActionFunction(event);
                    }
                });
        ...
        AFRAME.registerPrimitive('a-gui-button', {
            ...
            mappings: {
                ...
                'on': 'gui-button.on',
                'adjust': 'gui-button.adjust',
                'simadjust': 'gui-button.simadjust',
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        AFRAME.registerComponent('gui-circle-timer', {
            schema: {
                ...
                fontFamily: {type: 'string', default: 'Arial'},
                fontSize: {type: 'string', default: '150px'},
                fontColor: {type: 'string', default: "#0E53A7"},
            ...
            init: function init() {
                ...
                var initCount = this.initCount = data.value;
                ...
                el.setAttribute('geometry', 'primitive: plane; height: ' + guiItem.height + '; width: ' + guiItem.height + ';');
                el.setAttribute('material', 'shader: flat; transparent: true; opacity: 0; side:double; color:' + data.backgroundColor + ';');

                drawText(ctx, canvas, data.value, data.fontSize, data.fontFamily, data.fontColor, 1, 'center', 'middle');
                ...
                timerContainer.setAttribute('gui-interactable');
                ...
                timerIndicator1.setAttribute('material', 'shader: flat; opacity: 1; side:double; color: ' + "#0E53A7");
                ...
                timerIndicator1.setAttribute('position', '0 0 0.035');
                el.appendChild(timerIndicator1);
                var timerIndicator2 = document.createElement("a-ring");
                timerIndicator2.setAttribute('material', 'shader: flat; opacity: 1; side:double; color: ' + "#0E53A7");
                ...
                timerIndicator2.setAttribute('position', '0 0 0.035');
                el.appendChild(timerIndicator2);
                var timerIndicator3 = document.createElement("a-ring");
                timerIndicator3.setAttribute('material', 'shader: flat; opacity: 1; side:double; color: ' + "#0E53A7");
                ...
                timerIndicator3.setAttribute('position', '0 0 0.035');
                el.appendChild(timerIndicator3);
                var timerIndicator4 = document.createElement("a-ring");
                timerIndicator4.setAttribute('material', 'shader: flat; opacity: 1; side:double; color: ' + "#0E53A7");
                ...
                timerIndicator4.setAttribute('position', '0 0 0.035');
                ...
                el.addEventListener('mouseenter', function (evt) {
                    ...
                    timerRing.setAttribute('radius-inner', '' + guiItem.height / 5);
                    timerRing.setAttribute('radius-outer', '' + guiItem.height / 3);
                    timerRing.setAttribute('theta-length', '360');
                });

                el.addEventListener('mouseleave', function (evt) {
                    timerRing.setAttribute('radius-inner', '' + guiItem.height / 3);
                    timerRing.setAttribute('radius-outer', '' + guiItem.height / 2);
                    timerRing.setAttribute('theta-length', '0');
                });

                //TODO
                el.addEventListener('reset', function (evt) {
                    _this.initCount = parseInt(el.getAttribute('value'))
                });


                el.addEventListener(data.on, function (evt) {
                    let guiInteractable = el.getAttribute("gui-interactable");
                    let clickActionFunctionName = guiInteractable.clickAction;
                    let clickActionFunction = window[clickActionFunctionName];
            ...
            update: function update(oldData) {
                ...
                if (data.value !== oldData.value) {
                    ...
                    var left = data.value;
                    let count_down = this.initCount;
                    var elapsed = Math.round((count_down - left) * 100 / count_down) / 100 * 360;
                    ring.setAttribute('theta-length', elapsed); // this has to increase 0 to 360 when running the count_down
                    // console.log(elapsed);
                    //text doesn't update
        ...
        AFRAME.registerPrimitive('a-gui-circle-timer', {
            ...
            mappings: {
                ...
                'border-hover-color': 'gui-circle-timer.borderHoverColor',
                'onclick': 'gui-interactable.clickAction',
            }
        });
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        AFRAME.registerComponent('gui-cursor', {
            schema: {
                ...
                hoverColor: {type: 'string', default: key_white},
                activeColor: {type: 'string', default: "#E0B669"},
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        AFRAME.registerComponent('gui-icon-button', {
            schema: {
                ...
                backgroundColor: {type: 'string', default: key_grey},
                hoverColor: {type: 'string', default: key_grey_dark},
                activeColor: {type: 'string', default: '#d3d3d4'}
            },
            init: function init() {
                ...
                var guiInteractable = el.getAttribute("gui-interactable");
                //console.log("in button, guiInteractable: "+JSON.stringify(guiInteractable));
                var multiplier = 480; // POT conversion
                var canvasWidth = guiItem.height * multiplier; //square
                var canvasHeight = guiItem.height * multiplier;
                ...
                var textEntity = document.createElement("a-entity");
                textEntity.setAttribute('geometry', 'primitive: plane; width: ' + guiItem.height / 1.7 + '; height: ' + guiItem.height / 1.7 + ';');
                textEntity.setAttribute('material', 'shader: flat; src: #' + canvas.id + '; transparent: true; opacity: 1; alphaTest: 0.5; side:front; color: ' + data.activeColor);
                textEntity.setAttribute('position', '0 0 0.041');
                ...
                el.addEventListener(data.on, function (evt) {
                    ...
                    var clickActionFunctionName = guiInteractable.clickAction;
                    if (clickActionFunctionName === 'showHidePassword') showHidePassword(el);
                    else {
                        doListen = true;
                        let i = 0;
                        ...
                        let intr = setInterval(function () {
                            if (doListen === true) {
                                //window[clickActionFunctionName];
                                let tempFunction = new Function("window." + clickActionFunctionName + "()");
                                tempFunction();
                            }
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        AFRAME.registerComponent('gui-icon-label-button', {
            ...
            init: function init() {
                ...
                iconEntity.setAttribute('position', iconEntityX + ' 0.01 0.041');
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        AFRAME.registerComponent('gui-input', {
            ...
            init: function init() {
                ...
                borderTopEntity.setAttribute('geometry', 'primitive: box; width: ' + guiItem.width + '; height: 0.01; depth: 0.02;');
                borderTopEntity.setAttribute('material', 'shader: flat; opacity: 1; side:double; color: ' + data.borderColor);
                borderTopEntity.setAttribute('position', '0 -' + (guiItem.height / 2 - 0.005) + ' 0.01');
                el.appendChild(borderTopEntity);
                var borderBottomEntity = document.createElement("a-entity");
                borderBottomEntity.setAttribute('geometry', 'primitive: box; width: ' + guiItem.width + '; height: 0.01; depth: 0.02;');
                borderBottomEntity.setAttribute('material', 'shader: flat; opacity: 1; side:double; color: ' + data.borderColor);
                borderBottomEntity.setAttribute('position', '0 ' + (guiItem.height / 2 - 0.005) + ' 0.01');
                el.appendChild(borderBottomEntity);
                var borderLeftEntity = document.createElement("a-entity");
                borderLeftEntity.setAttribute('geometry', 'primitive: box; width: 0.01; height: ' + guiItem.height + '; depth: 0.02;');
                borderLeftEntity.setAttribute('material', 'shader: flat; opacity: 1; side:double; color: ' + data.borderColor);
                borderLeftEntity.setAttribute('position', '-' + (guiItem.width / 2 - 0.005) + ' 0 0.01');
                el.appendChild(borderLeftEntity);
                var borderRightEntity = document.createElement("a-entity");
                borderRightEntity.setAttribute('geometry', 'primitive: box; width: 0.01; height: ' + guiItem.height + '; depth: 0.02;');
                borderRightEntity.setAttribute('material', 'shader: flat; opacity: 1; side:double; color: ' + data.borderColor);
                borderRightEntity.setAttribute('position', guiItem.width / 2 - 0.005 + ' 0 0.01');
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        AFRAME.registerComponent('gui-label', {
            schema: {
                ...
                fontSize: {type: 'string', default: '110px'},
                fontFamily: {type: 'string', default: 'Helvetica'},
                fontColor: {type: 'string', default: key_grey_dark},
        ...
        AFRAME.registerComponent('gui-radio', {
            ...
            init: function init() {
                ...
                if (data.ischeck == false) {
                    ...
                    radioBox.setAttribute('scale', '1 0.1 1');
                    ...
                    radioCenter.setAttribute("id", this.el.id + "radioCenter");
                    ...
                    //TODO
                    if (data.checked) {
                        radioCenter.setAttribute('material', 'color:' + 'black' + '; shader: flat;');
                    } else {
                    ...
                    el.setAttribute('geometry', 'primitive: plane; height: ' + guiItem.height + '; width: ' + toWidth + ';');
                    ...
                    labelEntity.setAttribute('geometry', 'primitive: plane; width: ' + labelWidth + '; height: ' + guiItem.height / 1.05 + ';');
                    labelEntity.setAttribute('material', 'shader: flat; src: #' + labelCanvas.id + '; transparent: true; opacity: 1; side:front;');
                    labelEntity.setAttribute('position', labelEntityX + ' 0 0.0005');
                    el.appendChild(labelEntity);
                    ...
                    let checkBox = document.createElement("a-gui-label");
                    checkBox.setAttribute('width', guiItem.height * 0.5 * data.radiosizecoef);
                    checkBox.setAttribute('height', '0.25');
                    checkBox.setAttribute('rotation', '0 0 0');
                    checkBox.setAttribute('background-color', data.handleColor);
                    checkBox.setAttribute('font-color', 'black');
                    checkBox.setAttribute('position', radioBoxX + ' 0 0.001');
                    checkBox.setAttribute('scale', '1 1 1');
                    ...
                    var labelEntityX = guiItem.height * 0.5 - guiItem.width * 0.025;
                    var labelEntity = document.createElement("a-entity");
                    labelEntity.setAttribute('geometry', 'primitive: plane; width: ' + labelWidth + '; height: ' + guiItem.height / 1.05 + ';');
                    labelEntity.setAttribute('material', 'shader: flat; src: #' + labelCanvas.id + '; transparent: true; opacity: 1; side:front;');
                    labelEntity.setAttribute('position', labelEntityX + ' 0 0.0005');
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        AFRAME.registerComponent('gui-slider', {
            ...
            init: function init() {
                ...
                handleContainer.id = "sliderInteraction";
                ...
                el.addEventListener('click', function (evt) {
                    ...
                    if (form.getAttribute('visible') === true) {
                        ...
                        //TODO
                        el.setAttribute("percent", data.percent);
                        let activeWidth = data.percent * 2;
                        if (activeWidth == 0) activeWidth = 0.000000001;
                        let width = 2 - data.percent * 2;
                        if (width == 0) width = 0.000000001;
                        //TODO

                        sliderActiveBar.setAttribute('geometry', 'primitive: box; width: ' + activeWidth + '; height: 0.05; depth: 0.03;');
                        sliderActiveBar.setAttribute('position', data.percent - 1 + ' 0 0.02');

                        sliderBar.setAttribute('geometry', 'primitive: box; width: ' + width + '; height: 0.05; depth: 0.03;');
                        sliderBar.setAttribute('position', data.percent * 1 + ' 0 0.02');

                        handleContainer.setAttribute('position', data.percent * 2 - 1 + ' 0 0.03');
                        let guiInteractable = el.getAttribute("gui-interactable");
                        let clickActionFunctionName = guiInteractable.clickAction;
                        postElementPress(clickActionFunctionName, parseInt(parseFloat(data.percent) * 100));
                    }
                });


                // TODO drag listener
                el.addEventListener('drag', function (evt) {

                    let localCoordinates = el.object3D.worldToLocal(evt.detail.intersection.point);
                    //TODO localZ == local.z ??
                    if (localCoordinates.x >= -1.1 && localCoordinates.x <= 1.1 && Math.round(localZ) === Math.round(localCoordinates.z)) {
                        let newPercent;
                        console.log(localZ + " USPESNE " + localCoordinates.z)
                        var sliderBarWidth = 2; // total width of slider bar
                        if (localCoordinates.x <= -sliderBarWidth / 2) {
                            newPercent = 0;
                        } else if (localCoordinates.x >= sliderBarWidth / 2) {
                            ...
                            newPercent = (localCoordinates.x + sliderBarWidth / 2) / sliderBarWidth;
                        }
                        if (newPercent != data.percent) {
                            ...
                            sliderBar.setAttribute('geometry', 'primitive: box; width: ' + width + '; height: 0.05; depth: 0.03;');
                            sliderBar.setAttribute('position', data.percent + ' 0 0.02');
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        AFRAME.registerComponent('gui-toggle', {
            schema: {
                ...
                backgroundColor: {type: 'string', default: key_offwhite},
                hoverColor: {type: 'string', default: key_grey_light},
                activeColor: {type: 'string', default: "#0E53A7"},
                handleColor: {type: 'string', default: key_offwhite}
            },
            init: function init() {
                ...
                //TODO zmena tbox id
                toggleBox.setAttribute("id", this.el.id + "tbox");
                ...
                toggleBox.setAttribute('position', 0 + ' 0 0');
                ...
                toggleHandle.setAttribute("id", this.el.id + "thandle");
