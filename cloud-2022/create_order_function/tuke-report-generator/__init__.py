...
# blob storage canteens
    try:
        blob = BlobClient.from_connection_string(
            ...
            container_name="tuke-reports",
            blob_name="tuke-report-canteens.csv")
    ...
    try:
        blob = BlobClient.from_connection_string(
            conn_str="DefaultEndpointsProtocol=https;AccountName=functionappscloudy;AccountKey=yKLgiGWscrpY6HlW0UxNMESivlO6vHStxmrZE5nsnBHMjcVfwPA9rxOVviFESXCZy2mGiaPFSOzMsKOPjWr4WQ==;EndpointSuffix=core.windows.net",
            container_name="tuke-reports",
            blob_name="tuke-report-food.csv")
        #  upload the created file
    ...
    TEXT_ADMIN = "Hello TUKE admin! Weekly reports have been generated. You can start analysing after downloading them. Click on this link to see weekly report by canteen: " + blob_url_canteens + " Click on this link to see top selling foods this week: " + blob_url_foods + " UniCanteen Team"
    try:
